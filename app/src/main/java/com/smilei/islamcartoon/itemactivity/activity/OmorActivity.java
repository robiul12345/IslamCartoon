...
public class OmorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_omor);
    ...
    private void Omor_Recyclerview() {
        ...
        recyclerView = findViewById(R.id.activity_omor_Id);
        adpter = new Costom_item_Adpter(OmorActivity.this, model_item);
    ...
    private void english_abdulbarifetchdata() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, omar,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(OmorActivity.this, "Error!!" + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
