...
public class GrandmaActivity extends AppCompatActivity {
    ...
    private void Islamm_Recyclerview() {
        ...
        recyclerView_islam = findViewById(R.id.activity_grandma_Id);
        adpter = new Costom_item_Adpter(GrandmaActivity.this, model_item);
    ...
    private void islamfetchdata() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, grandma,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(GrandmaActivity.this, "Error!!" + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
