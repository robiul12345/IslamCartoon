...
public class KahanyaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kahanya);
        ...
        Activity_Kahanya_Recyclerview();
    }


    private void Activity_Kahanya_Recyclerview() {
        model_item = new ArrayList<>();
        recyclerView = findViewById(R.id.activity_kahanya_Id);
        adpter = new Costom_item_Adpter(KahanyaActivity.this, model_item);
    ...
    private void english_abdulbarifetchdata() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, kahanya,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(KahanyaActivity.this, "Error!!" + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
