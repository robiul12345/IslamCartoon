...
public class AbdulBari_Bangla_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abdul_bari__bangla_);
        ...
        Bangla_abdulbari_Recyclerview();
    }
    private void Bangla_abdulbari_Recyclerview() {
        model_item = new ArrayList<>();
        recyclerView = findViewById(R.id.activity_abdul_bari_bangla_Id);
        adpter = new Costom_item_Adpter(AbdulBari_Bangla_Activity.this, model_item);
    ...
    private void english_abdulbarifetchdata() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, abdulbaribangla,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(AbdulBari_Bangla_Activity.this, "Error!!" + error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
